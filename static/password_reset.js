document.addEventListener("DOMContentLoaded", function () {
    ...
    const emailInput = document.getElementById("reset_email") || document.getElementById("email");
    const otpInput = document.getElementById("otp");
    const newPasswordInput = document.getElementById("new_password");
    const confirmPasswordInput = document.getElementById("confirm_new_password") || document.getElementById("confirm_password");
