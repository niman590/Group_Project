...
def test_auth_routes_function_inventory(route_modules):
    expected = [
        ...
        "get_post_lock_failed_attempts",
        "get_locked_until",
        "is_currently_time_locked",
        "get_remaining_lock_minutes",
        "refresh_user",
        "sync_session_user",
        "redirect_after_login",
        "reset_login_security_state",
        "activate_15_minute_lock",
        "activate_24_hour_lock",
        "activate_permanent_lock",
        "clear_expired_time_lock_if_needed",
