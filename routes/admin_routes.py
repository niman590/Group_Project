...
def download_suspicious_events_pdf():
    ...
    story.append(Paragraph(f"<b>Generated By:</b> {admin_user['first_name']} {admin_user['last_name']}", normal_style))
    ...
    for event in events:
        ...
        description = event["description"] if "description" in event.keys() and event["description"] else "-"
    ...
    report_table = Table(
        table_data,
        colWidths=[27 * mm, 38 * mm, 18 * mm, 22 * mm, 22 * mm, 20 * mm, 35 * mm],
        repeatRows=1,
    )
